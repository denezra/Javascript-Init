...
function enablerInitHandler() {
	...
	csAd.glow_col				= document.getElementById('glow_col');
	...
	csAd.bg_col.style.background 		 	= "url('loreal_bg_col.jpg')";
	csAd.bg_col.style.backgroundSize		= "320px 50px";
	csAd.bg_col.style.width 				= "320px";
	csAd.bg_col.style.height			    = "50px";

	csAd.glow_col.style.background 		 	= "url('glow_left_col.png')";
	...
	function preloadedCollapse() {
		...
		function animate_col() {
			...
			setTimeout(function() {
				csAd.glow_col.className += " fade-in-text4_col-divide_col-tex5_col";
			}, 350)
...
function expandHandler() {
	...
	csAd.shine_exp 				 = document.getElementById('shine_exp'),
	...
	csAd.shine_exp.style.background 	 			= "url('shine_effects.png')";
	csAd.shine_exp.style.backgroundSize  			= "320px 64px";
	csAd.shine_exp.style.width 						= "320px";
	...
	function preloadedExpand() {
		...
		function expandInitiate() {
			// Timer Variable
			var timer1, timer2, timer3, timer4, timer5, timer7, timer8, timer6,
			...
			function animateFrame1() {
				...
				timer1 = setTimeout(function() {
					csAd.shine_exp.className		  += " fade-bottom-shine_exp"
					...
					timer2 = setTimeout(function(){
						csAd.text1_scene_frame1_exp.className += " fade-down-text1_text2_text3_exp";
						timer3 = setTimeout(function(){
							csAd.text2_scene_frame1_exp.className += " fade-down-text1_text2_text3_exp";
							timer4 = setTimeout(function(){
								csAd.text3_scene_frame1_exp.className += " fade-down-text1_text2_text3_exp";
								timer5 = setTimeout(function(){
									...
									timer11 = setTimeout(function() {
										csAd.arrow_frame1_exp.className 	  += " arrow-animation";
									}, 1200)
			...
			function reset() {
				...
				clearTimeout(timer10);clearTimeout(timer11);
			}
		};
	}
